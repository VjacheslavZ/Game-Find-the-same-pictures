...
;(function () {
    ...
    httpGetPlayFields("https://kde.link/test/get_field_size.php")
        .then(response => ready(response))
        .catch(response => ready());

    function ready(response = {width: 5, height: 4}) {
    ...
    class PlayGame{
       ...
       startGame(self) {
        ...
        createRandomPictures(self) {
            ...
            for (let key in self._settings.urlImages){
